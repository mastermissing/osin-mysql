...
var schemas = []string{
	...
	`CREATE TABLE IF NOT EXISTS {prefix}_access (
		...
		prev_access_token      varchar(255) BINARY NOT NULL,
	...
	`CREATE TABLE IF NOT EXISTS {prefix}_refresh (
		access_token        varchar(255) BINARY NOT NULL,
		refresh_token       varchar(255) BINARY NOT NULL PRIMARY KEY
	)`,
	`CREATE TABLE IF NOT EXISTS {prefix}_expires (
		id 		int(11) NOT NULL PRIMARY KEY AUTO_INCREMENT,
		code_or_token		varchar(255) BINARY NOT NULL,
